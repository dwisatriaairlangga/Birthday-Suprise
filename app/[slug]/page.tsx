...
const themes = {
  ...
  sakuraPink: { bg: '#FFF4F7', envelope: '#E85D88', text: 'text-white', accent: '#F28CA8', boxInside: '#8A2B47', boxLid: '#E85D88', boxBorder: '#BA4366', boxBaseBorder: '#C94B72' },
  oceanBlue: { bg: '#E3F2FD', envelope: '#1565C0', text: 'text-white', accent: '#4BA1D8', boxInside: '#0D47A1', boxLid: '#1565C0', boxBorder: '#0D47A1', boxBaseBorder: '#115293' },
  dalkomBlue: { bg: '#FCF1DD', envelope: '#2945A8', text: 'text-white', accent: '#F78660', boxInside: '#1A2E46', boxLid: '#2945A8', boxBorder: '#1A2E46', boxBaseBorder: '#2945A8' },
  matchaPink: { bg: '#FADADD', envelope: '#7C9D70', text: 'text-white', accent: '#FDF5C9', boxInside: '#4A7C39', boxLid: '#7C9D70', boxBorder: '#4A7C39', boxBaseBorder: '#5D9B47' },
  lilacBubblegum: { bg: '#FFC0CB', envelope: '#C8A2C8', text: 'text-white', accent: '#FFF0F5', boxInside: '#6F4E8B', boxLid: '#C8A2C8', boxBorder: '#6F4E8B', boxBaseBorder: '#8B5BA3' },
  scrapbookBlue: { bg: '#F2E8D9', envelope: '#5A80A6', text: 'text-white', accent: '#F29CB0', boxInside: '#2E5A7F', boxLid: '#5A80A6', boxBorder: '#2E5A7F', boxBaseBorder: '#3E6FA3' },
  dustyNavy: { bg: '#DDAEB2', envelope: '#1A2E46', text: 'text-white', accent: '#DDB24A', boxInside: '#0D1B2E', boxLid: '#1A2E46', boxBorder: '#0D1B2E', boxBaseBorder: '#132340' },
  oliveGold: { bg: '#DDB24A', envelope: '#595F37', text: 'text-white', accent: '#F3E6D6', boxInside: '#2F3620', boxLid: '#595F37', boxBorder: '#2F3620', boxBaseBorder: '#3D4529' },
  plumCream: { bg: '#F3E6D6', envelope: '#4F2C3A', text: 'text-white', accent: '#DDAEB2', boxInside: '#2A1620', boxLid: '#4F2C3A', boxBorder: '#2A1620', boxBaseBorder: '#3D1F2E' },
  orangeTeal: { bg: '#245D63', envelope: '#CA5B31', text: 'text-white', accent: '#EAE1CC', boxInside: '#0F3339', boxLid: '#245D63', boxBorder: '#0F3339', boxBaseBorder: '#174450' },
  forestSand: { bg: '#EAE1CC', envelope: '#1D5139', text: 'text-white', accent: '#D3A95B', boxInside: '#0F2A1F', boxLid: '#1D5139', boxBorder: '#0F2A1F', boxBaseBorder: '#163A2B' },
  burgundyGold: { bg: '#D3A95B', envelope: '#6C1226', text: 'text-white', accent: '#F2E8D9', boxInside: '#3A0A13', boxLid: '#6C1226', boxBorder: '#3A0A13', boxBaseBorder: '#511019' },
  turquoiseCoral: { bg: '#F27E6A', envelope: '#007F86', text: 'text-white', accent: '#F2E8D9', boxInside: '#003D41', boxLid: '#007F86', boxBorder: '#003D41', boxBaseBorder: '#005A62' },
  lavenderSlate: { bg: '#585966', envelope: '#C1A8C5', text: 'text-gray-900', accent: '#DDAEB2', boxInside: '#2A2D35', boxLid: '#585966', boxBorder: '#2A2D35', boxBaseBorder: '#3D4049' },
  deepGreenBlush: { bg: '#F1CAD0', envelope: '#0B4A31', text: 'text-white', accent: '#F2E8D9', boxInside: '#052A1E', boxLid: '#0B4A31', boxBorder: '#052A1E', boxBaseBorder: '#08363D' },
};
