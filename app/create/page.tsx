                  ...
                  <div key={i} className="flex gap-3 items-start bg-white p-3 rounded-xl border shadow-sm">
                    <div className="flex-1 space-y-2">
                      <div className="flex gap-2">
                        <input type="text" placeholder="Judul Lagu" value={track.title} onChange={e => updateTrack(i, 'title', e.target.value)} className="w-full text-sm border-gray-200 p-2.5 rounded-lg outline-none focus:ring-1 focus:ring-gray-800" required />
                        <input type="text" placeholder="Penyanyi" value={track.artist} onChange={e => updateTrack(i, 'artist', e.target.value)} className="w-full text-sm border-gray-200 p-2.5 rounded-lg outline-none focus:ring-1 focus:ring-gray-800" required />
                      </div>
                      <input type="text" placeholder="Link YouTube/Spotify/Apple Music" value={track.url} onChange={e => updateTrack(i, 'url', e.target.value)} className="w-full text-sm border-gray-200 p-2.5 rounded-lg outline-none focus:ring-1 focus:ring-gray-800" required />
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select className="w-full bg-white border-gray-200 rounded-xl p-3 border outline-none focus:ring-2 focus:ring-gray-800" onChange={e => setFormData({...formData, accessory: e.target.value})}>
                      ...
                      <option value="sparkles">Taburan Kilau ✨</option><option value="heart">Stiker Hati ❤️</option><option value="paperclip">Klip Kertas 📎</option>
                    </select>
                  </div>
                  <div>
                    ...
                    <div className="flex gap-2 items-center">
                      ...
                      <input type="text" placeholder={formData.usePin ? "Masukkan PIN..." : "Tidak terkunci"} disabled={!formData.usePin} value={formData.pin} onChange={e => setFormData({...formData, pin: e.target.value})} className="w-full bg-white border-gray-200 rounded-xl p-3 border outline-none focus:ring-2 focus:ring-gray-800 disabled:opacity-50" />
                    </div>
                  </div>
                </div>
              </div>
